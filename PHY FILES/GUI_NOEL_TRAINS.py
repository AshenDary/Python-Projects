...
class TrainFareCalculator:
    ...
    def reset_inputs(self):
        ...
        self.card_type_menu.config(state='normal')
        self.passenger_type_menu.config(state='normal')
        self.terminal_menu.config(state='normal')
        self.start_station_menu.config(state='normal')
        self.end_station_menu.config(state='normal')
    ...
    def create_widgets(self):
        ...
        self.no_button = tk.Button(self.button_container, text="No", command=self.end_travel, font=button_font, bg="#e74c3c", fg="white")

        self.yes_button.pack(side=tk.LEFT, padx=10, pady=8)
        self.continue_button.pack(side=tk.LEFT, padx=10, pady=8)
        self.no_button.pack(side=tk.LEFT, padx=10, pady=8)
    ...
    def track_time(self, event):
        ...
        self.card_type_menu.config(state='disabled')
        self.passenger_type_menu.config(state='disabled')
        self.terminal_menu.config(state='disabled')
    ...
    def disable_all_inputs(self):
        ...
        self.passenger_type_menu.config(state="disabled")
        self.terminal_menu.config(state="disabled")
        self.start_station_menu.config(state="disabled")
        self.end_station_menu.config(state="disabled")
