...
class TrainFareCalculator:
    ...
    def create_widgets(self):
        ...
        self.yes_button = tk.Button(self.transfer_button_frame, text="Transfer", command=self.switch_lines, font=button_font)
        self.continue_button = tk.Button(self.transfer_button_frame, text="Continue", command=self.continue_travel, font=button_font)
        self.no_button = tk.Button(self.transfer_button_frame, text="No", command=self.end_travel, font=button_font)
